...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      ...
      md:grid-cols-3 lg:grid-cols-4 gap-6 my-8 max-w-3xl'>
            ...
            <div key={index} className='mt-4 flex items-center justify-between'>
              ...
              <div className='flex items-center gap-2 font-medium'>
                <p className='text-sm text-gray-500'>
                  {currency}{booking.price}</p>
                <p className='px-3 py-0.5 border border-Color rounded-full text-sm'>{booking.status}</p>
              </div>
            </div>
          ))}
        </div>

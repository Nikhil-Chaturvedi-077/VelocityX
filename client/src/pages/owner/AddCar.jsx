...
const AddCar = () => { 
  ...
  const {axios,concurrency} = useAppContext();
      ...
      text-sm mt-6 max-w-xl'>
        ...
        <div className='flex items-center gap-2 w-full'>
         ...
         <div className='grid grid-cols-1           md:grid-cols-2 gap-6'>
            ...
            <div className='flex flex-col w-full'>
              <label>Model</label>
              <input type="text" placeholder='e.g. E-class, M4, X5...' required
                className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
                value={car.model}
            ...
            {/* car tranmission , fuel type, seating capacity */}
            ...
            <div className='flex flex-col w-full'>
              ...
              <textarea row={5} placeholder='A luxurious SUV with a spacious interior and a powerful engine.' required
                className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
